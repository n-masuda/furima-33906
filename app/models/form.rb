class Form
  ...
  attr_accessor :user_id, :item_id, :postal_code, :city, :add_line1, :add_line2, :phone, :prefecture_id, :order_id

  with_options presence: true do
    validates :postal_code, format: { with: /\A\d{3}[-]\d{4}\z/, message: "incorrect" }
    validates :city
    validates :add_line1
    validates :phone, numericality: { only_integer:true,less_than:12} 
